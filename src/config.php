...
/**
 * socialite config.php
 *
 * This file exists only as a template for the socialite settings.
 * It does nothing on its own.
 *
 * Don't edit this file, instead copy it to 'craft/config' as 'socialite.php'
